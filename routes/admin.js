  ...
  try {
    ...
    if (existCompany.length == 1) {
      ...
      var companymaster = new companyMasterSchema({
        ...
        panCard:
          req.files.panCard == undefined ? null : req.files.panCard[0].path,
        cancelledCheque:
          req.files.cancelledCheque == undefined
            ? null
            : req.files.cancelledCheque[0].path,
  ...
  try {
    if (multipleServiceProviderRequired == false) {
      ...
      var companyInventory = new companyInventoryMasterSchema({
        ...
        inventoryDescription: inventoryDescription,
        appointmentMinutes:
          multipleServiceProviderRequired == true ? null : appointmentMinutes,
        multipleServiceProviderRequired: multipleServiceProviderRequired,
        rateType: multipleServiceProviderRequired == true ? null : rateType,
        rateAmt: multipleServiceProviderRequired == true ? null : rateAmt,
        inventoryNotes1Name:
          multipleServiceProviderRequired == true ? null : inventoryNotes1Name,
        inventoryNotes1:
          multipleServiceProviderRequired == true ? null : inventoryNotes1,
        inventoryNotes2Name:
          multipleServiceProviderRequired == true ? null : inventoryNotes2Name,
        inventoryNotes2:
          multipleServiceProviderRequired == true ? null : inventoryNotes2,
        inventoryNotes3Name:
          multipleServiceProviderRequired == true ? null : inventoryNotes3Name,
        inventoryNotes3:
          multipleServiceProviderRequired == true ? null : inventoryNotes3,
        inventoryAvailable:
          multipleServiceProviderRequired == true ? null : inventoryAvailable,
      });
      companyInventory.save();
      ...
      for (i = 0; i < serviceProvider.length; i++) {
        var companyServicesProvider = new companyServicesProviderSchema({
          ...
          serviceProviderDescription:
            serviceProvider[i].serviceProviderDescription,
